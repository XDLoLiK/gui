SRC_DIRS := . app app/window app/renderer app/event_manager slots common widgets
VPATH += $(SRC_DIRS)
...
CXX_FLAGS += -D _DEBUG -ggdb3 -std=c++20 -O2 -Wall -Wextra -Weffc++ -Waggressive-loop-optimizations\
