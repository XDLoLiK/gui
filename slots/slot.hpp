...
{
using Function = void (*) (Object&, Args...);

public:
	FunctionHandler(Object& object, Function funciton):
		EventHandler<Args...>(),
		m_object(object),
		m_funciton(funciton)
	{
...
template <class Object, class ...Args>
EventHandler<Args...>* newFunctionHandler(Object& object, 
	                                      void (*funciton) (Object&, Args...))
{
    return new FunctionHandler<Object, Args...>(object, funciton);
}

#define METHOD(Object, Method)     newMethodHandler   (Object, &Method)
#define FUNCTION(Object, Function) newFunctionHandler (Object, &Function)
